...
const HABIT_ANTIJOINT: DiagnosisCopy = {
  ...
  bodyPrimary: [
    ...
    '家长可以这样做：主动纠正——引导孩子有意识地自我控制，同时留意孩子容易出现这些动作的场景，通过转移注意力或轻声提醒，针对性中断习惯。',
    '家长可以这样做：专业干预——如果宝贝自己改不掉不良习惯，可以请儿童口腔科或正畸医生评估，进行口周肌功能训练，或佩戴简单矫治器帮助破除习惯。',
  ],
  bodySecondary: [
...
const HABIT_PROTRUSION: DiagnosisCopy = {
  ...
  bodyPrimary: [
    ...
    '家长可以这样做：主动纠正——引导孩子有意识地自我控制，同时留意孩子容易出现这些动作的场景，通过转移注意力或轻声提醒，针对性中断习惯。',
    '家长可以这样做：专业干预——如果自己改不掉不良习惯，可以请儿童口腔科或正畸医生评估，进行肌功能训练或佩戴矫正器，物理阻断不良习惯。',
  ],
  bodySecondary: [
...
const HABIT_BREATH: DiagnosisCopy = {
  ...
  bodyPrimary: [
    ...
    '家长可以这样做：去耳鼻喉科排查鼻炎、腺样体肥大等病因，并进行针对性治疗；在确保鼻腔通气问题已解决的前提下，请儿童口腔科或正畸医生评估，进行唇肌功能训练或佩戴功能矫治器，引导鼻呼吸；若口呼吸习惯已经导致了牙弓狭窄或颌骨发育异常，则需佩戴矫治器纠正骨骼畸形。',
  ],
  bodySecondary: [
...
const HABIT_ASYMMETRY: DiagnosisCopy = {
  ...
  bodyPrimary: [
    ...
    '家长可以这样做：检查孩子是否存在单侧蛀牙、缺牙或牙齿疼痛，先治疗牙齿疾病，解除根本原因；引导孩子有意识地用两侧后牙轮流咀嚼，纠正托腮、歪头写作业的习惯。',
    '家长可以这样做：如果自己改不掉不良习惯，可以请儿童口腔科或正畸医生评估，进行肌功能训练，或佩戴简单矫治器辅助纠正偏侧咀嚼和托腮习惯。',
  ],
  bodySecondary: [
