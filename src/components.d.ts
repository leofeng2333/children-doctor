...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    DetailAnalysisFailed: typeof import('./components/DetailAnalysisFailed.vue')['default']
...
declare global {
  ...
  const DetailAnalysisFailed: typeof import('./components/DetailAnalysisFailed.vue')['default']
